...
import MealFillForm from "./clientPages/MealFillForm";
import MealViewForm from "./clientPages/MealViewForm";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          path="/dashboard"
          element={<ProtectedRoute element={HomePageOne} allowedRole="admin" />}
        />
        <Route
          path="/employees"
          element={
        ...
        <Route
          path="/facilities"
          element={
            <ProtectedRoute element={ManageFacilities} allowedRole="admin" />
          }
        />
        <Route
          path="/create-invoice"
          element={
            <ProtectedRoute element={CreateInvoicePage} allowedRole="admin" />
          }
        />
        <Route
          path="/attendance"
          element={
            <ProtectedRoute element={ManageAttendance} allowedRole="admin" />
          }
        />
        <Route
          path="/settings"
        ...
        <Route
          path="/all-packages"
          element={
            <ProtectedRoute element={ClientPackagesPage} allowedRole="team" />
          }
        />
        <Route
          path="/my-packages"
        ...
        <Route
          ...
          element={
            <ProtectedRoute element={PaymentHistoryPage} allowedRole="team" />
          }
        />
        <Route
          path="/edit-profile"
        ...
        <Route
          ...
          element={
            <ProtectedRoute element={FacilityDetailpage} allowedRole="team" />
          }
        />
        <Route
          path="/kitchen-view-form"
          element={
            <ProtectedRoute
        ...
        <Route
          ...
          element={
            <ProtectedRoute element={EditProfilePage} allowedRole="customer" />
          }
        />
        <Route
        ...
        <Route
          path="/customer-forms"
          element={
            <ProtectedRoute element={CustomerForms} allowedRole="customer" />
          }
        />
